        ...
        <div class="box-body">
            ...
            <div>
                ...
                <?php if ($jogo->getIdUsuarioInclusao() == $this->getUserSession()['id']): ?>
                    ...
                    <a data-message="<?= sprintf('Deseja excluir o jogo <strong>%s</strong>?', $jogo->getNome()) ?>" class="confirm" href="<?= $this->url(array('module' => 'admin', 'controller' => 'jogo', 'action' => 'excluir', 'id' => $jogo->getId())) ?>" title="Excluir"><i class="fa fa-trash fa-2x c-red m-r-5" aria-hidden="true"></i></a>
                <?php endif; ?>
            </div>
